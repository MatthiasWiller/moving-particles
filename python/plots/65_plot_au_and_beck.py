...
g_list_mp1     = np.load(direction + 'mp_au_beck_N' + repr(N_mp[0]) + '_Nsim100_b5_cs_sss2_g_list.npy')
g_list_mp2     = np.load(direction + 'mp_au_beck_N' + repr(N_mp[1]) + '_Nsim100_b10_cs_sss2_g_list.npy')
g_list_mp3     = np.load(direction + 'mp_au_beck_N' + repr(N_mp[2]) + '_Nsim100_b20_cs_sss2_g_list.npy')
...
# set labels
plt.xlabel(r'Threshold level, $b$')
...
# set labels
plt.xlabel(r'Threshold value, $b$')
