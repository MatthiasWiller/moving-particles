"""
# ---------------------------------------------------------------------------
# Moving Particles Example 2 (study-file)
# ---------------------------------------------------------------------------
# Created by:
...
# nsamples_list = [460, 236, 158, 119, 96, 80, 68, 60, 53, 48, 44, 40, 37, 34, 32, 30, 28, 27, 25, 24]
...
for i in range(0, len(burn_in_list)):
    ...
    # file-name
    filename = 'python/data/example2/burnin_tradeoff_5e3/mp_waarts_N' + repr(N) + \
