...
# b_line_sus, pf_line_sus = uutil.get_pf_line_and_b_line_from_SUS(g_list_mcs, p0, n_samples_per_level)

b_line_list_mp, pf_line_list_mp   = uutil.get_pf_line_and_b_line_from_MP(g_list_mp, n_initial_samples)
legend_list_mp = ['MP1','MP2', 'MP3', 'MP4', 'MP5']
...
# pf_line_list.append(pf_line_mp)
...
uplt.plot_pf_over_b(b_line_list+b_line_list_mp, pf_line_list+pf_line_list_mp, legend_list+legend_list_mp)
