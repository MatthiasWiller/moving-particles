...
for Nb in burn_in_list:
    g_list_mp_tmp = np.load(direction + example_name +'_N100_Nsim100_b'+ repr(Nb) +'_cs_sss2_g_list.npy')
...
# plot cov over b
plt.figure()
plt.plot(burn_in_list, cov_ref,'.-', label=r'Analytical')
...
# plot pf over b
plt.figure()
plt.plot(burn_in_list, pf_ref,'.-', label=r'Analytical')
