...
cov_mmh_est = np.array([])
cov_cs_est  = np.array([0.17821342, 0.25565418, 0.33789344, 0.37837155, 0.5596796, 0.61266539])
cov_acs_est = np.array([0.17030047, 0.23853249, 0.34479622, 0.35877576, 0.4155104, 0.41706365])

cov_mmh_ana = np.array([])
